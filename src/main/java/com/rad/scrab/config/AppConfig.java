...
import com.rad.scrab.model.Authorities;
...
@ComponentScans(value = { @ComponentScan("com.rad.scrab.dao"), @ComponentScan("com.rad.scrab.service") })
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setAnnotatedClasses(User.class, Authorities.class, ReplayMatch.class, ReplayUnit.class,
				ReplayWord.class);
